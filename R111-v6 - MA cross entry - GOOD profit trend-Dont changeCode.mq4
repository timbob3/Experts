...
double StochMain   = iStochastic(NULL,0, 21, 7, 3, MODE_SMA, 0, MODE_MAIN  , 0);
double StochSignal = iStochastic(NULL,0, 21, 7, 3, MODE_SMA, 0, MODE_SIGNAL, 0);
...
//BUY***   
   if(Open[1]<iMa && Close[1]>iMa)// && tradedThisBar==false)
   {
