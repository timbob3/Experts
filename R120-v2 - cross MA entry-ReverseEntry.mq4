...
//--- get Moving Average 
 //  ma=iMA(NULL,0,MovingPeriod,MovingShift,MODE_SMA,PRICE_CLOSE,0);
   ...
   if(Crossed()==1)   //-----BUY conditions
     {
      res=OrderSend(Symbol(),OP_BUY,LotsOptimized(),Ask,3,Bid-Stoploss*Point,0,"",MAGICMA,0,Blue);
      return;
     } 
   ...
   if(Crossed()==2)   //---- SELL conditions
     {
      res=OrderSend(Symbol(),OP_SELL,LotsOptimized(),Bid,3,Ask+Stoploss*Point,0,"",MAGICMA,0,Red);
      return;
     }    
  }
