...
//----
   ...
   if(MONEY_MANAGEMENT) LOTS=NormalizeDouble(AccountBalance()*AccountLeverage()/1000000*RISK_RATIO,0)*MarketInfo(Symbol()
   ,MODE_MINLOT);
...
//+------------------------------------------------------------------+   
    ...
    Comment("mGRID EXPERT ADVISOR ver 2.0\n",
            ...
            "Stop limit:  ",MarketInfo(Symbol(),MODE_STOPLEVEL),"\n",
