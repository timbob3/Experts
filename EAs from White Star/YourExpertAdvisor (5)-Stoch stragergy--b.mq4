...
extern int StopLoss = 1800;
extern bool UseTakeProfit = False;
extern int TakeProfit = 60;
extern bool UseTrailingStop = True;
extern int TrailingStop = 1400;
...
double StochMainPrevBar = iStochastic(NULL, 0, 5, 3, 3, MODE_SMA, 0, MODE_MAIN, Current + 1);
double StochSellLevel = 70;
double StochBuyLevel = 30;
  ...
  double ma2=iMA(NULL,0,MovingPeriod,MovingShift2,MODE_SMA,PRICE_CLOSE,0);
   ...
   if (StochMain>StochBuyLevel && StochMainPrevBar<StochBuyLevel)   Order = SIGNAL_BUY;
   if (StochMain<StochSellLevel && StochMainPrevBar>StochSellLevel) Order = SIGNAL_SELL;
