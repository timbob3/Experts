...
input int    MovingPeriod34  =60;
input int    MovingShiftA  =0;
input int    MovingShiftB  =2;
...
double StochMainPrevBar = iStochastic(NULL, 0, 5, 3, 3, MODE_SMA, 0, MODE_MAIN, 1);
  ...
  double ma4=iMA(NULL,0,MovingPeriod34,MovingShiftB,MODE_SMA,PRICE_CLOSE,0);   
   ...
   if (StochMain<StochBuyLevel && StochMain>StochSignal && ma1>ma2 && ma3>ma4 )   Order = SIGNAL_BUY;
   if (StochMain>StochSellLevel && StochMain<StochSignal && ma1<ma2 && ma3<ma4) Order = SIGNAL_SELL;
